...
namespace ConsoleApp1
{
    class Program
    {
        ...
        {
            SeamCarver.SeamCarverWrapper.CarveVertically(imagePath: "LeetCode_SpanT.jpg", columnsToCarve: 1000, savePath: "LeetCode_SpanT.bmp", ImageFormat.bmp, CancellationToken.None, crop: false);
